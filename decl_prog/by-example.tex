...
So for \sym{len/1},
this is an equation between \sym{len} applied to a list,
and the length of that list.

% XXX the following point is made in the next para:
...
For a predicate of arity $n$,
each atom in the table consists of
the predicate name applied to $n$ terms.
In this case the atom is not an equation
and there is no result term,
rather, it states that
the arguments satisfy the relation denoted by that predicate.
In the case of \sym{app/3}
there are three list arguments,
the third of which is the result of appending the first two.
...
\begin{IEEEeqnarray*}{c}
    \ct{unput}(z, [x_1, \ldots, x_n, z], [x_1, \ldots, x_n]) \\
    \ct{unget}(z, [x_1, \ldots, x_n], [z, x_1, \ldots, x_n])
\end{IEEEeqnarray*}
Finally,
...
\begin{IEEEeqnarray*}{c}
    \ct{eq}([x_1, \ldots, x_n], [x_1, \ldots, x_n]) \\
    \ct{list}([x_1, \ldots, x_n]) = [x_1, \ldots, x_n]
\end{IEEEeqnarray*}
That is,
...
we can give the intended interpretation of the \sym{queue/2}
data constructor.
...
\IEEEeqnarraymulticol{3}{l}{
    \ct{list}(\ct{queue}([f_1, \ldots, f_n], [b_1, \ldots, b_m])
} \\ \quad
    & = & \ct{list}([f_1, \ldots, f_n, b_m, \ldots, b_1]) \\
    & = & [f_1, \ldots, f_n, b_m, \ldots, b_1] \\
\IEEEeqnarraymulticol{3}{l}{
    \ct{append}([f_1, \ldots, f_n], \ct{reverse}([b_1, \ldots, b_m]))
} \\ \quad
    & = & \ct{append}([f_1, \ldots, f_n], [b_m, \ldots, b_1]) \\
    & = & [f_1, \ldots, f_n, b_m, \ldots, b_1]
\end{IEEEeqnarray*}
...
\begin{IEEEeqnarray*}{rCl}
    \IEEEeqnarraymulticol{3}{l}{
        \ct{put}(z, \ct{queue}([f_1, \ldots, f_n], [b_1, \ldots, b_m]),
            \ct{queue}([f_1, \ldots, f_n], [z, b_1, \ldots, b_m]))
    } \\ \quad
    & \Leftrightarrow &
        \ct{put}(z, [f_1, \ldots, f_n, b_m, \ldots, b_1],
            [f_1, \ldots, f_n, b_m, \ldots, b_1, z]) \\
    & \Leftrightarrow &
        \ct{put}(z, [x_1, \ldots, x_{m+n}], [x_1, \ldots, x_{m+n}, z])
\end{IEEEeqnarray*}
\begin{verbatim}
    get(Z, queue([Z | F], B), queue(F, B)).
\end{verbatim}
\begin{IEEEeqnarray*}{rCl}
    \IEEEeqnarraymulticol{3}{l}{
        \ct{get}(z, \ct{queue}([z, f_1, \ldots, f_n], [b_1, \ldots, b_m]),
            \ct{queue}([f_1, \ldots, f_n], [b_1, \ldots, b_m]))
    } \\ \quad
    & \Leftrightarrow &
        \ct{get}(z, [z, f_1, \ldots, f_n, b_m, \ldots, b_1],
            [f_1, \ldots, f_n, b_m, \ldots, b_1]) \\
    & \Leftrightarrow &
        \ct{get}(z, [z, x_1, \ldots, x_{m+n}], [x_1, \ldots, x_{m+n}])
\end{IEEEeqnarray*}
\begin{verbatim}
    unput(Z, queue(F, [Z | B]), queue(F, B)).
\end{verbatim}
\begin{IEEEeqnarray*}{rCl}
    \IEEEeqnarraymulticol{3}{l}{
        \ct{unput}(z, \ct{queue}([f_1, \ldots, f_n], [z, b_1, \ldots, b_m]),
            \ct{queue}([f_1, \ldots, f_n], [b_1, \ldots, b_m]))
    } \\ \quad
    & \Leftrightarrow &
        \ct{unput}(z, [f_1, \ldots, f_n, b_m, \ldots, b_1, z],
            [f_1, \ldots, f_n, b_m, \ldots, b_1]) \\
    & \Leftrightarrow &
        \ct{unput}(z, [x_1, \ldots, x_{m+n}, z], [x_1, \ldots, x_{m+n}])
\end{IEEEeqnarray*}
\begin{verbatim}
    unget(Z, queue(F, B), queue([Z | F], B)).
\end{verbatim}
\begin{IEEEeqnarray*}{rCl}
    \IEEEeqnarraymulticol{3}{l}{
        \ct{unget}(z, \ct{queue}([f_1, \ldots, f_n], [b_1, \ldots, b_m]),
            \ct{queue}([z, f_1, \ldots, f_n], [b_1, \ldots, b_m]))
    } \\ \quad
    & \Leftrightarrow &
        \ct{unget}(z, [f_1, \ldots, f_n, b_m, \ldots, b_1],
            [z, f_1, \ldots, f_n, b_m, \ldots, b_1]) \\
    & \Leftrightarrow &
        \ct{unget}(z, [x_1, \ldots, x_{m+n}], [z, x_1, \ldots, x_{m+n}])
\end{IEEEeqnarray*}
...
\begin{IEEEeqnarray*}{rCl}
    \IEEEeqnarraymulticol{3}{l}{
        [z, f_1, \ldots, f_n] = \ct{reverse}([b_1, \ldots, b_m])
    } \\ \quad
    & \Leftrightarrow &
        [z, f_1, \ldots, f_n] = [b_m, \ldots, b_1]
\end{IEEEeqnarray*}
...
\begin{IEEEeqnarray*}{rCl}
    \IEEEeqnarraymulticol{3}{l}{
        \ct{get}(z, \ct{queue}([], [b_1, \ldots, b_m]),
            \ct{queue}([f_1, \ldots, f_n], []))
    } \\ \quad
    & \Leftrightarrow &
        \ct{get}(z, [b_m, \ldots, b_1], [f_1, \ldots, f_n])
\end{IEEEeqnarray*}
...
\begin{IEEEeqnarray*}{rCl}
    \quad & \Leftrightarrow &
        \ct{get}(z, [z, f_1, \ldots, f_n], [f_1, \ldots, f_n])
        \hspace{5.1em} \\
    & \Leftrightarrow &
        \ct{get}(z, [z, x_1, \ldots, x_n], [x_1, \ldots, x_n])
\end{IEEEeqnarray*}
